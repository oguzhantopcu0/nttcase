...
pad_se = tf.keras.preprocessing.sequence.pad_sequences(enco_d, maxlen=200)
...
class sentiment:
    ...
    def model_sentiment(self):
        ...
        self.model.add(tf.keras.layers.Embedding(voc_s, self.embed_v_l, input_length=200))
        self.model.add(tf.keras.layers.LSTM(50))
    ...
    def predict_sentiment(self):
        ...
        for i in range(len(df_list)):
            ...
            tok = tf.keras.preprocessing.sequence.pad_sequences(tok, maxlen=200)
